...
On the client side, run:
    python benchmarks/benchmark_serving_random.py \
        --backend <backend> \
        --model <your_model> \
...
def main(args: argparse.Namespace):
    ...
    if args.dataset_name != "random":
        raise ValueError("This simplified version only supports the 'random' dataset. "
                         "Please use --dataset-name random.")
...
if __name__ == "__main__":
    parser = FlexibleArgumentParser(
        description="Benchmark the online serving throughput using random data.")
    parser.add_argument(
        "--backend",
        type=str,
        default="vllm",
    ...
    parser.add_argument(
        ...
        help='The tokenizer mode. "auto" will use the fast tokenizer if available.')
